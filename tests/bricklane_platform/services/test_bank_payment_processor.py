...
class TestBankPaymentProcessor(unittest.TestCase):

    def setUp(self):
        self.payment_processor = PaymentProcessor()

    def test_bank_get_payments(self):
    ...
    def test_bank_get_payments_empty(self):
        fixture = get_path("bank_payments_empty.csv")

        payments = self.payment_processor.get_payments(fixture, "bank")
        self.assertEqual(len(payments), 0)

    def test_bank_verify_payments(self):
        ...
        self.assertEqual(result, [payment1])
